    ...
    vector<int> correct(string s) {
        ...
        forl(i,0,sz){
            if(s[i] == '('){
                a++;
                if(a > (sz-i-1)){
                    //number of open brackets is greater than remaining brackets
                    //so use a close bracket ')'
                    v.pb(i);
                    a -= 2;
                }
            }else{
                a--;
                if(a<0){
                    //too many close brackets, so use a open bracket '('
                    v.pb(i);
                    a += 2;
                }
            }
